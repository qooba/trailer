...
from asciimatics.renderers import StaticRenderer, ColourImageFile, FigletText, ImageFile, Fire, Kaleidoscope, Rainbow, Plasma
...
class EatingScene(Scene):
    ...
    def reset(self, old_scene=None, screen=None):
        ...
        self.add_effect(
        Print(self._screen,
              StaticRenderer(images=[still_hungry]),
              x = 100,
              y = self._screen.height * 2 // 3 - 0,
              speed = 1,
...
def demo(screen):
    ...
    effects = [
        ...
        Print(screen,
              StaticRenderer(images=[loading]),
              screen.height * 2 // 4 - 2,
              speed = 1,
              colour=Screen.COLOUR_WHITE, stop_frame=30),
    ]
    ...
    effects = [
        Print(screen,
              StaticRenderer(images=[loading2]),
              screen.height * 2 // 4 - 2,
              speed = 1,
              colour=Screen.COLOUR_WHITE, stop_frame = 30),
    ]
    ...
    effects = [
        Print(screen,
              StaticRenderer(images=[loading3]),
              screen.height * 2 // 4 - 2,
              speed = 1,
              colour=Screen.COLOUR_WHITE, stop_frame = 30),
    ]
    ...
    effects = [
        Print(screen,
              StaticRenderer(images=[loading4]),
              screen.height * 2 // 4 - 2,
              speed = 1,
              colour=Screen.COLOUR_WHITE, stop_frame = 30),
    ]
    ...
    effects = [
        Print(screen,
              StaticRenderer(images=[appetite]),
              x = 10,
              y = screen.height * 2 // 3 - 35,
              speed = 1,
              colour=Screen.COLOUR_WHITE),
    ...
    effects = [
        Print(screen,
              ...
              transparent=False),
        Print(screen,
              StaticRenderer(images=[ai]),
              y = screen.height * 2 // 3 - 15,
              speed = 1,
              colour=Screen.COLOUR_WHITE),
    ...
    effects = [
        RandomNoise(screen,
                    signal=StaticRenderer(images=[mlops]))
    ]
    scenes.append(Scene(effects, -1))
    ...
    effects = [
        Print(screen,
            ...
            transparent=False),
        Print(screen,
              StaticRenderer(images=[and_more]),
              y = screen.height * 2 // 3 - 15,
              speed = 1,
              colour=Screen.COLOUR_WHITE),
    ...
    # YUMMY RECIPES BY QOOBA
    effects = [
        #Print(screen, ImageFile("yummy_transparent_nochat.png", 30),
        #      x=10,
        #      y=10,
        #      ),

        Print(screen,
              StaticRenderer(images=[yummy]),
              x = 100,
              y = screen.height * 2 // 3 + 0,
              speed = 1,
              colour=Screen.COLOUR_WHITE),
    ]
    scenes.append(Scene(effects, 0))
    ...
    effects = [
        Print(screen,
              StaticRenderer(images=[end]),
              x = 5,
              y = screen.height * 2 // 3 - 10,
              speed = 1,
              colour=Screen.COLOUR_WHITE),
    ]
    scenes.append(Scene(effects, 0))
